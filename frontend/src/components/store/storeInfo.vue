<template>
    <div id="storeApp">
        <!-- <h1>{{placeSimpleInfo.marker.placeInfo.placeName}}</h1>
                                                        <p class="title">{{placeSimpleInfo.marker.placeInfo.phone}}</p>
                                                        <p>{{placeSimpleInfo.marker.placeInfo.addressName}}</p>
                                                        <a href="#"><i class="fa fa-dribbble"></i></a>
                                                        <a href="#"><i class="fa fa-twitter"></i></a>
                                                        <a href="#"><i class="fa fa-linkedin"></i></a>
                                                        <a href="#"><i class="fa fa-facebook"></i></a>
                                                        <p><button class="storeButton">Contact</button></p> -->
    </div>
</template>
